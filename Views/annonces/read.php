    ...
    <div class="w-9/12 p-5 bg-white border shadow-md rounded-xl">
        <div class="flex items-center justify-between w-full pb-3 border-b">
            ...
            <div class="flex items-center space-x-8">
                <button class="px-3 py-1 text-xs font-semibold border rounded-2xl bg-neutral-100">Category</button>
                <div class="text-xs text-neutral-500"><?= $annonce->getDiffHumainDate() ?></div>
            </div>
        </div>

        <div class="mt-4 mb-6">
            <h2 class="mb-3 text-xl font-bold"><?= $annonce->getTitle() ?></h2>
